...
//
//
string HtmlParser::getTag(string html, string tag, int & start)
{
...
//
//
string  HtmlParser::getAllTags(string html, string tag)
{
	string result("");
	int start = 0;
	for(;;)
...
//
string  HtmlParser::hrefFormat(string html)
{
...
// 
//
string  HtmlParser::splitIntoStrings(string text, int stringLength = 80)
{
	string result("");
